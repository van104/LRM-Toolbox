...
const presetColors = [
    '#FF5733', '#33FF57', '#3357FF', '#F3FF33', '#FF33F3', '#33FFF3', '#F333FF', '#FFF333',
    '#5733FF', '#FF3357', '#57FF33', '#000000', '#333333', '#666666', '#999999', '#CCCCCC', '#FFFFFF',
    '#E6E6FA', '#D8BFD8', '#BA55D3', '#9370DB', '#8A2BE2', '#4B0082', '#6A5ACD', '#7B68EE',
    '#00BFFF', '#1E90FF', '#4169E1', '#0000FF', '#000080', '#90EE90', '#3CB371', '#228B22', '#008000',
    '#FFD700', '#FFA500', '#FF8C00', '#FF4500', '#FF0000', '#DC143C', '#B22222', '#800000'
];
