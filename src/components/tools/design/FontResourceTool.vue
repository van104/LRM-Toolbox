    ...
    <div class="font-resource-tool">
        ...
        <div class="search-section">
            <div class="search-box glass-card">
                ...
                <input type="text" v-model="searchKeyword" placeholder="输入字体名称关键词，尝试在下方平台搜索..." class="search-input"
            ...
            <div v-for="lib in libraries" :key="lib.name" class="lib-card glass-card">
                <div class="lib-header">
                    <div class="lib-icon-wrapper" :style="{ background: lib.colorBg }">
                        <span class="text-icon" :style="{ color: lib.colorText }">{{ lib.iconText || lib.name[0]
                        }}</span>
                    </div>
                ...
                <div class="lib-actions">
                    ...
                    <button class="btn-search" :disabled="!searchKeyword || !lib.searchUrl" :title="getSearchTitle(lib)"
...
const libraries = [
    {
        name: 'Google Fonts',
        description: '全球最大的开源字体库，提供大量免费可商用的 WebFont，无需下载即可在网页中直接引用。',
    ...
    {
        name: '字由 (HelloFont)',
        description: '设计师必备的字体管理工具，聚合全球海量字体，支持一键激活到设计软件，无需安装字体文件。',
    ...
    },
    {
        ...
        description: 'Adobe 官方字体服务，订阅 Creative Cloud 即可商用海量高品质字体，无缝集成 Adobe 全家桶。',
    ...
    {
        name: 'Font Squirrel',
        description: '精选的高质量免费商用字体库，提供 Webfont Generator 工具，可将本地字体转换为 Web 格式。',
