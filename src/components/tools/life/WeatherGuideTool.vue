                ...
                <div v-if="weatherData" class="weather-content animate-fade-in">
                    ...
                    <div class="weather-header">
                        <div class="location-info">
                            ...
                            <span class="coords">{{ weatherData.lat.toFixed(2) }}°N, {{ weatherData.lon.toFixed(2)
                                }}°E</span>
                        </div>
                        <div class="current-weather">
                            <div class="temp-big">{{ Math.round(weatherData.current.temperature_2m) }}°</div>
                            <div class="condition">
                                <div class="weather-text">{{ getWeatherDesc(weatherData.current.weather_code) }}</div>
                                <div class="range">
                    ...
                    <div class="keywords-bar">
                        <span v-for="tag in calculatedKeywords" :key="tag.text" class="keyword-tag" :class="tag.type">
                            #{{ tag.text }}
                        </span>
                    </div>
...
import { Back, Search, Loading, Warning, Sunny, User, Bicycle, Basketball } from '@element-plus/icons-vue'
