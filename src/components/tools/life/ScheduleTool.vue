      ...
      <section class="control-panel glass-card">
        <div class="week-selector">
          <div class="current-week-info">
            ...
            <el-tag
              v-if="currentViewWeek === realCurrentWeek"
              size="small"
              type="success"
              effect="dark"
              class="today-tag"
          ...
          <div class="week-nav">
            <el-button-group>
              ...
              <el-button :disabled="currentViewWeek >= totalWeeks" @click="changeWeek(totalWeeks)"
                >最后周</el-button
              >
            </el-button-group>
...
(3-4节)3-12周/6号楼301/张老师"
    ...
    <el-dialog v-model="settingsVisible" title="学期设置" width="500px">
      <el-form :model="settingsForm" label-width="100px">
        ...
        <el-form-item label="总周数">
          <el-input-number
            v-model="settingsForm.total_weeks"
            :min="1"
            :max="52"
            style="width: 100%"
          />
    ...
    <footer class="footer">© 2026 LRM工具箱 - 课程表管理</footer>
  </div>
</template>
...
<script setup>
  ...
  const loadData = () => {
    try {
      ...
      console.error('Failed to load schedule data', _e);
    }
  };
  ...
  watch([courses, startDate, totalWeeks, timeSlots], () => {}, { deep: true });
</script>
