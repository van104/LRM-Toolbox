    ...
    <main class="main-content">
      <div class="calculator-body glass-card">
        <div class="display-screen">
          ...
          <div class="current-line" :class="{ 'small-text': currentVal.length > 10 }">
            {{ currentVal || '0' }}
          </div>
        </div>
        ...
        <div class="keypad">
          <div class="key-row">
            ...
            <button class="btn fn" @click="handleMem('M-')">M-</button>
            <button class="btn fn" :class="{ active: isScientific }" @click="toggleMode">
              Sci
            </button>
          </div>
          ...
          <div class="main-keys">
            ...
            <button class="btn action" @click="backspace">
              <el-icon>
                <Back />
              </el-icon>
            </button>
      ...
      <div class="calc-history glass-card">
        ...
        <button v-if="historyList.length" class="clear-hist-btn" @click="historyList = []">
          清空记录
        </button>
      </div>
    </main>

    <footer class="footer">© 2026 LRM工具箱 - 科学计算器</footer>
  </div>
</template>
