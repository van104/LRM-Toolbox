        ...
        <div class="tool-container">
            ...
            <div class="calendar-controls card">
                <el-radio-group v-model="currentYear" size="large">
                    <el-radio-button v-for="year in availableYears" :key="year" :label="year">{{ year
                    }}年</el-radio-button>
                </el-radio-group>
                <div class="legend">
...
import { holidayData, availableYears, getHolidaysByYear, getNextHoliday } from '@/data/holidayData'


const now = new Date()
const defaultYear = now.getFullYear().toString()
const currentYear = ref(availableYears.includes(defaultYear) ? defaultYear : availableYears[availableYears.length - 1])
