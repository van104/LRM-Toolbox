    ...
    try {
        switch (type) {
            ...
            case 'dec2hex':
                ...
                outputText.value = BigInt(Math.floor(Number(text))).toString(16).toUpperCase()
                break
            case 'dec2bin':
            ...
            case 'url_dec':
                ...
                break
            case 'unicode_enc':
                outputText.value = text.split('').map(c => '\\u' + c.charCodeAt(0).toString(16).padStart(4, '0')).join('')
                break
            case 'unicode_dec':
            ...
            case 'utf8_hex':
                ...
                outputText.value = Array.from(data).map(b => b.toString(16).padStart(2, '0').toUpperCase()).join(' ')
                break
            case 'hex_utf8':
