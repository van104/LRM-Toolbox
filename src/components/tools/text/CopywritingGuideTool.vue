  ...
  <div class="brutal-wrapper">
    <div class="brutal-container">
      <header class="brutal-header">
        ...
        <h1 class="brutal-title">中英文<span>排版美化()</span></h1>
        <div class="badge">📖 Copywriting Guide</div>
      </header>
        ...
        <div class="layout-grid">
          ...
          <section class="brutal-pane">
            <div class="pane-header bg-yellow">
              <span class="panel-title">1. 原始文本 (RAW)</span>
            ...
            <div class="editor-wrapper">
              <textarea
                v-model="inputText"
                class="code-editor"
                placeholder="在此输入或粘贴需要美化排版的文本..."
                spellcheck="false"
              ></textarea>
            </div>

            <div class="options-bar bg-yellow">
              <label class="checkbox-label">
                <input v-model="addSpaces" type="checkbox" /> 中英文之间增加空格
              </label>
              <label class="checkbox-label">
                <input v-model="fixPunctuation" type="checkbox" /> 修正全半角标点
              </label>
              <label class="checkbox-label">
                <input v-model="trimLines" type="checkbox" /> 去除首尾多余空格
              </label>
            </div>
          </section>
          ...
          <div class="switch-area">
            <button class="brutal-btn min-btn bg-pink text-white" @click="processText">
              ✨ 美化排版
            </button>
          </div>
          ...
          <section class="brutal-pane">
            <div class="pane-header bg-blue text-white">
              <span class="panel-title">2. 排版结果 (RESULT)</span>
              <div class="panel-actions">
                <button
                  class="brutal-btn icon-btn text-white"
                  :disabled="!outputText"
                  @click="copyResult"
                >
                  📋 复制
...
<script setup lang="ts">
  ...
  const copyResult = () => {
    ...
    copyToClipboard(outputText.value, { success: '结果已复制' });
  };
</script>
