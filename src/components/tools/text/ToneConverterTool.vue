            ...
            <div class="tool-card glass-card">
                ...
                <div class="modes-section">
                    <div class="mode-headers">
                        <button :class="{ active: mode === 'question' }" @click="mode = 'question'">疑问/探询</button>
                        <button :class="{ active: mode === 'polite' }" @click="mode = 'polite'">温和/委婉</button>
                        <button :class="{ active: mode === 'formal' }" @click="mode = 'formal'">正式/书面</button>
                        <button :class="{ active: mode === 'customer' }" @click="mode = 'customer'">客服/礼貌</button>
                    </div>
                </div>
...
const resultText = computed(() => {
    ...
    if (mode.value === 'formal') {
        ...
        const map = {
            '说': '表示', '觉得': '认为', '看看': '查阅', '大约': '约', '需要': '需',
            '买': '采购', '卖': '销售', '钱': '资金', '能不能': '是否可以',
            '对不对': '是否正确', '哪里': '何处', '时候': '时', '因为': '由于'
        }
