                ...
                <section class="tools-panel">
                    <div class="tabs-header">
                        ...
                        <button :class="['tab-btn', { active: currentTab === 'join' }]" @click="currentTab = 'join'">🔗
                            拼接</button>
                        <button :class="['tab-btn', { active: currentTab === 'csv' }]" @click="currentTab = 'csv'">📊
                            表格/列</button>
                    </div>
                    ...
                    <div class="tools-content">
                        ...
                        <div v-if="currentTab === 'split'" class="tool-group">
                            ...
                            <div class="action-buttons">
                                <button class="action-btn primary" @click="doSplit('separator')">按分隔符拆分</button>
...
function doSplit(mode) {
    ...
    if (mode === 'separator') {
        ...
        switch (splitOptions.separatorType) {
            ...
            case 'tab': sep = '\t'; break;
            case 'custom': sep = splitOptions.customSeparator; break;
        }
