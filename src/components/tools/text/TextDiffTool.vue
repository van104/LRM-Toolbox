  ...
  <div class="tool-page">
    ...
    <div class="tool-content">
      ...
      <div class="control-bar">
        ...
        <el-checkbox v-if="diffMode === 'lines'" v-model="ignoreWhitespace" label="忽略空格" border />
      </div>
      ...
      <div class="input-area">
        <div class="input-column">
          ...
          <textarea v-model="originalText" class="code-editor" placeholder="在此输入原始文本..." spellcheck="false"></textarea>
        </div>
...
v-model="modifiedText" class="code-editor" placeholder="在此输入修改后的文本..."
      ...
      <div v-if="originalText || modifiedText" class="result-area">
        ...
        <div v-if="diffMode === 'lines'" class="diff-viewer-lines" :class="viewMode">
          ...
          <div v-for="(row, index) in diffRows" :key="index" class="diff-row" :class="{ 'has-diff': row.hasDiff }">
