                ...
                <section class="tools-panel">
                    ...
                    <div class="tools-content">
                        ...
                        <div v-if="currentTab === 'simple'" class="tool-group">
                            ...
                            <div class="control-row">
                                <label>替换为:</label>
                                <input v-model="simpleOptions.replace" class="text-input" placeholder="输入替换内容" />
                            </div>
                        ...
                        <div v-if="currentTab === 'line'" class="tool-group">
                            <div class="sub-group">
                                ...
                                <div class="control-row">
                                    <input v-model="lineOptions.prefix" class="text-input" placeholder="前缀 (Prefix)" />
                                    <input v-model="lineOptions.suffix" class="text-input" placeholder="后缀 (Suffix)" />
                                </div>
                            ...
                            <div class="sub-group">
                                ...
                                <div class="flex-row">
                                    ...
                                    <button class="action-btn small" @click="doLineFilter('remove')">删除包含行</button>
                                </div>
                            ...
                            <div class="sub-group">
                                ...
                                <div class="flex-row">
                                    <button class="action-btn small" @click="doPadding('start')">前补全 (Start)</button>
...
function doLineModify() {
    ...
    outputText.value = lines.map(line => `${lineOptions.prefix}${line}${lineOptions.suffix}`).join('\n')
    showToast('前后缀添加完成')
}
