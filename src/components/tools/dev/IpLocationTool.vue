        ...
        <main class="main-content">
            <div class="tool-card glass-card">
                ...
                <div class="search-section">
                    ...
                    <div class="quick-actions">
                        ...
                        <span @click="ipInput = '8.8.8.8'; fetchInfo()">Google DNS</span>
                        <span @click="ipInput = '1.1.1.1'; fetchInfo()">Cloudflare</span>
                    </div>
                </div>
                ...
                <div v-if="result" class="result-box animate-fade-in">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-card">
                            ...
                            <div class="sub-value">UTC {{ result.timezone.utc }} ({{ result.timezone.current_time }})
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tips-card">
                ...
                <div class="tip-content">
                    <p>数据说明：查询服务基于 Ipwhois 和 IP.SB 公共 API。查询结果仅供参考，不支持 IPv6 详细街道级定位。</p>
                </div>
            </div>
        </main>

        <footer class="footer">
            © 2026 LRM工具箱 - IP 属地简易查询
        </footer>
    </div>
</template>
...
import { Back, Loading, Warning, LocationInformation, Right, InfoFilled } from '@element-plus/icons-vue'
