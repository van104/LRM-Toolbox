<template>
  <div class="html-tool">
        ...
        <div class="dual-pane">
          <div class="pane">
            <div class="pane-header">
              ...
              <div class="actions">
                ...
                <button class="action-btn encode" @click="doHtmlEscape">
                  转义 Escape &gt;&gt;
                </button>
              </div>
            </div>
            <textarea
              v-model="htmlRaw"
              placeholder="输入 HTML 代码，如：<div>Hello</div>..."
              class="pane-input code-font"
            ></textarea>
          </div>
          ...
          <div class="pane">
            <div class="pane-header">
              ...
              <div class="actions">
                <button class="action-btn decode" @click="doHtmlUnescape">
                  &lt;&lt; 还原 Unescape
                </button>
            ...
            <textarea
              v-model="htmlEscaped"
              placeholder="输出实体代码，如：&lt;div&gt;Hello&lt;/div&gt;..."
              class="pane-input code-font"
            ></textarea>
          </div>
        </div>
    ...
    <footer class="footer">© 2026 LRM工具箱 - HTML 实体转义工具</footer>
  </div>
</template>
