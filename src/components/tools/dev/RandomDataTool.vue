<template>
  <div class="tool-page">
      ...
      <div class="layout-container">
        <aside class="config-panel">
          <div class="tabs-header">
            ...
            <button
              :class="['tab-btn', { active: currentTab === 'mock' }]"
      ...
      <div class="help-section">
        ...
        <div class="help-grid">
          ...
          <div class="help-card">
            ...
            <div class="example">支持 JSON 导出，由 <code>Mock.js</code> 驱动。</div>
          </div>
          <div class="help-card">
            <h4>3. JSON 模拟</h4>
    ...
    <footer class="footer">© 2026 LRM工具箱 - 随机数据生成器</footer>
  </div>
</template>
