  ...
  <div class="tool-page">
    ...
    <div class="editor-container">
      ...
      <div class="editor-panel">
        ...
        <textarea v-model="outputJson" class="code-editor output" readonly placeholder="格式化结果将显示在这里..."></textarea>
      </div>
    </div>
...
import {
  ArrowLeft, Delete, MagicStick, Fold, CircleCheck,
  DocumentCopy, Document, CopyDocument, Download,
