<template>
  <div class="url-tool">
    ...
    <main class="main-content">
      <div class="tool-card glass-card">
        <div class="dual-pane">
          ...
          <div class="pane">
            ...
            <textarea
              v-model="urlEncoded"
              placeholder="输出编码结果，如：%E4%BD%A0%E5%A5%BD..."
      ...
      <div class="tips-card">
        ...
        <div class="tip-content">
          <p>
            说明：使用 <code>encodeURIComponent</code> 进行编码，适用于处理 URL 参数。空格会被编码为
            <code>%20</code>。
          </p>
        </div>
      </div>
    ...
    <footer class="footer">© 2026 LRM工具箱 - URL 编解码工具</footer>
  </div>
</template>
...
<script setup>
  ...
  const doUrlDecode = () => {
    try {
      ...
      urlDecoded.value = 'Error: Malformed URI sequence (编码格式错误)';
    }
  };
</script>
