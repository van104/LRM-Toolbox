...
const commonPorts = [
    ...
    { port: 443, service: 'HTTPS', desc: '安全的 HTTP (加密网页浏览, SSL/TLS)', proto: 'TCP', cat: 'Web' },
    { port: 8080, service: 'HTTP Alt', desc: 'HTTP 备用端口，常用于 Tomcat/代理', proto: 'TCP', cat: 'Web' },
    { port: 8000, service: 'HTTP Dev', desc: '常用 Web 开发/调试端口 (Django/Python)', proto: 'TCP', cat: 'Web' },

    
    { port: 20, service: 'FTP Data', desc: '文件传输协议 (数据传输)', proto: 'TCP', cat: '传输' },
    { port: 21, service: 'FTP Ctrl', desc: '文件传输协议 (命令控制)', proto: 'TCP', cat: '传输' },
    { port: 22, service: 'SSH/SFTP', desc: '安全外壳协议 (远程登录/文件传输)', proto: 'TCP', cat: '传输' },
    { port: 23, service: 'Telnet', desc: '远程终端协议 (明文传输，不推荐)', proto: 'TCP', cat: '传输' },
    ...
    { port: 143, service: 'IMAP', desc: '互联网邮件访问协议 (接收邮件)', proto: 'TCP', cat: '邮件' },
    { port: 465, service: 'SMTPS', desc: '安全的 SMTP over SSL', proto: 'TCP', cat: '邮件' },

    
    { port: 3306, service: 'MySQL', desc: 'MySQL / MariaDB 数据库默认端口', proto: 'TCP', cat: '数据库' },
    ...
    { port: 1433, service: 'SQL Server', desc: 'Microsoft SQL Server', proto: 'TCP', cat: '数据库' },
