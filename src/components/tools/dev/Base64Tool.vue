        ...
        <div class="code-box">
          <div class="box-header">
            ...
            <div class="box-actions">
              <el-button link type="primary" @click="copyToClipboard(imgBase64)">复制完整编码</el-button>
...
import {
  ArrowLeft, ArrowRight, Delete, DocumentCopy,
  CopyDocument, UploadFilled
