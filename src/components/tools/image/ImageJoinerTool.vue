                ...
                <div class="settings-panel glass-card">
                    ...
                    <div class="panel-section">
                        ...
                        <div class="settings-group">
                            ...
                            <el-slider v-model="config.borderRadius" :min="0" :max="100" @input="debouncedRender" />
                        </div>
                    </div>
                    ...
                    <div class="panel-section">
                        ...
                        <div class="settings-group mb-4">
                            ...
                            <el-color-picker v-model="config.backgroundColor" show-alpha @change="debouncedRender" />
                        </div>
...
import {
    ArrowLeft, Delete, Download, PictureFilled,
    Plus, Sort, Right, Grid, Close
...
const render = () => {
    ...
    if (container) {
        const scale = Math.min(container.clientWidth / layout.totalWidth, 800 / layout.totalHeight, 1)
...
const calculateLayout = () => {
    ...
    if (config.mode === 'vertical') {
        ...
        const firstImg = images.value[0].img
        const targetH = (outW - p * 2 - (count - 1) * s) / images.value.reduce((acc, cur) => acc + (cur.img.width / cur.img.height), 0)
