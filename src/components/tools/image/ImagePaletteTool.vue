    ...
    <div class="tool-page">
        ...
        <main class="tool-content">
            ...
            <div class="tips-section glass-card">
                <h4>工作原理</h4>
                <p>工具使用 ColorThief 算法分析图片像素，提取出最具代表性的 8 种主色调。这些颜色可用于设计配色参考、UI 主题生成等场景。</p>
            </div>
        </main>

        <component :is="'script'" src="https://cdnjs.cloudflare.com/ajax/libs/color-thief/2.3.0/color-thief.min.js">
        </component>
