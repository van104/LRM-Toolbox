        ...
        <div class="tool-content">
            ...
            <div class="controls-panel glass-card">
                <div class="form-group">
                    <label>条码内容</label>
                    <textarea v-model="barcodeValue" class="input-area" placeholder="请输入条形码内容..." rows="2"></textarea>
                </div>
...
v-model.number="barcodeHeight" type="number" min="10" max="150" step="5"
            ...
            <div class="preview-panel glass-card">
                ...
                <div ref="barcodeContainer" class="barcode-container">
                    ...
                    <div v-if="!barcodeValue" class="empty-msg">
                        请输入内容以生成条形码
                    </div>
                </div>
            </div>
...
import { Back, Download, Operation } from '@element-plus/icons-vue'
...
watch([barcodeValue, barcodeFormat, barcodeWidth, barcodeHeight, displayValue, lineColor, background], () => {
    generateBarcode()
})
