...
v-for="(slot, idx) in currentTemplate.slots_data" :key="idx" class="template-slot"
                    ...
                    <div v-if="selectedItem" class="context-toolbar glass-card">
                        <el-button-group size="small">
                            ...
                            <el-button type="danger" @click="removeItem"><el-icon>
                                    <Delete />
                                </el-icon></el-button>
                        </el-button-group>
...
import {
    ArrowLeft, Download, Plus, Picture, Delete, Top, Bottom,
    Star, PriceTag, CircleCheck, Location, Opportunity, Brush,
    Handbag, GoldMedal, MagicStick, Trophy
...
const templates = [
    {
        id: 'single', name: '大片封面', slots: 1,
        slots_data: [{ left: 5, top: 5, width: 90, height: 90, occupied: false }]
    },
    {
        id: 'vertical-2', name: '双图对齐', slots: 2,
        slots_data: [
