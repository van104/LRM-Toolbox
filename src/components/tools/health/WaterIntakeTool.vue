    ...
    <div class="water-intake-tool">
            ...
            <div class="layout-grid">
                ...
                <aside class="side-panel glass-card">
                    ...
                    <el-form :model="config" label-position="top">
                        ...
                        <el-button type="primary" class="reset-btn" @click="resetProgress">重置今日数据</el-button>
                    </el-form>
                </aside>
                    ...
                    <div class="progress-section">
                        ...
                        <div class="stats">
                            ...
                            <div class="stat-item">
                                ...
                                <span class="value">{{ Math.max(0, recommendedIntake - todayTotal) }}
                                    <small>ml</small></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="disclaimer-wrap" style="padding: 0 1.5rem 2rem; text-align: center;">
            <div class="disclaimer-card"
                ...
                <span>饮水建议基于通用公式计算，具体需求量可能因气候、疾病、运动强度等因素而异。如有疑问请咨询专业营养师。</span>
            </div>
        </div>
