    ...
    <div class="tool-page">
        <header class="tool-header">
            ...
            <div class="header-right">
                <el-button @click="resetTimer"><el-icon>
                        <Refresh />
        ...
        <main class="tool-content">
            <div class="timer-card glass-card" :class="currentState">
                <div class="mode-tabs">
                    <div class="tab" :class="{ active: mode === 'work' }" @click="switchMode('work')">专注 (25m)</div>
                    <div class="tab" :class="{ active: mode === 'short' }" @click="switchMode('short')">短休息 (5m)</div>
                    <div class="tab" :class="{ active: mode === 'long' }" @click="switchMode('long')">长休息 (15m)</div>
                </div>
