  ...
  <div class="healthy-diet-tool">
      ...
      <div class="layout-grid">
        ...
        <section class="main-workspace glass-card">
          <div class="macro-summary">
            ...
            >
              <div class="macro-icon" :style="{ backgroundColor: macro.color }">
                {{ macro.icon }}
              </div>
          ...
          <div class="distribution-section">
            ...
            <div class="meal-timeline">
              <div v-for="meal in mealDistribution" :key="meal.label" class="meal-node">
                ...
                <div
                  class="meal-bar"
                  :style="{ width: meal.ratio * 200 + '%', backgroundColor: '#3b82f6' }"
                ></div>
              </div>
            </div>
          </div>
    ...
    <div class="disclaimer-wrap" style="padding: 0 1.5rem 2rem; text-align: center">
      ...
      >
        ...
        <span
          >营养建议基于通用模型计算，不考虑个人疾病或特殊身体状况。严格的饮食计划应在注册营养师指导下进行。</span
        >
      </div>
    </div>

    <footer class="footer">© 2026 LRM工具箱 - 健康饮食建议</footer>
  </div>
</template>
