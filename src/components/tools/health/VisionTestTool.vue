  ...
  <div class="vision-test-tool">
            ...
            <div class="test-viewport">
              <div v-if="currentTest === 'color'" class="test-card">
                <div class="plate-container">
                  ...
                  <div class="plate-nav">
                    ...
                    <span class="plate-indicator"
                      >{{ currentPlate + 1 }} / {{ colorPlates.length }}</span
                    >
                    <el-button
                ...
                <div class="test-info">
                  ...
                  <div class="ans-box">
                    ...
                    <span v-if="showAns" class="ans-text"
                      >答案是：{{ colorPlates[currentPlate].ans }}</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div v-if="currentTest === 'astigmatism'" class="test-card">
                ...
                <div class="test-info">
                  <h4>散光检测图</h4>
                  <p>
                    请单眼观察，注视图中心。如果您感觉某些线条比其他线条更粗、更黑，可能存在散光。
                  </p>
                </div>
              </div>
              ...
              <div v-if="currentTest === 'grid'" class="test-card">
                ...
                <div class="test-info">
                  <h4>阿姆斯勒方格表</h4>
                  <p>
                    用于检测黄斑病变。请注视中心黑点。如果您发现网格线条出现扭曲、断裂或有黑影遮挡，请及时就医。
                  </p>
                </div>
              </div>
            </div>
    ...
    <div class="disclaimer-wrap" style="padding: 0 1.5rem 2rem; text-align: center">
      ...
      >
        ...
        <span
          >以上工具仅供初步自我筛查参考，不能替代专业的医疗诊断。如感眼部严重不适、视力骤降，请立即咨询专业眼科医生。</span
        >
      </div>
    </div>

    <footer class="footer">© 2026 LRM工具箱 - 视力自我监测</footer>
  </div>
</template>
