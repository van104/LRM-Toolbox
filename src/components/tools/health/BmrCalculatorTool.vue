  ...
  <div class="bmr-advanced-tool">
          ...
          <div class="result-summary">
            ...
            <div class="comparison-grid">
              ...
              <div class="bmr-card" :class="{ inactive: !form.bodyFat }">
                <h4>Katch-McArdle</h4>
                <div class="bmr-val">
                  {{ form.bodyFat ? Math.round(results.bmrKM) : '--' }}<span>kcal/d</span>
                </div>
                <p>基于瘦体重，体脂已知时更准</p>
              </div>
            </div>
    ...
    <div class="disclaimer-wrap" style="padding: 0 1.5rem 2rem; text-align: center">
      ...
      >
        ...
        <span
          >代谢率计算受激素水平、肌肉量、睡眠、补剂等多种动态因素影响，结果仅供理论推导与参考。</span
        >
      </div>
    </div>

    <footer class="footer">© 2026 LRM工具箱 - BMR 高阶计算</footer>
  </div>
</template>
