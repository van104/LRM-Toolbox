<template>
    <div class="chinese-poetry-tool">
        ...
        <main class="main-content">
            <header class="search-section glass-card">
                ...
                <div class="filter-tags">
                    <el-tag v-for="tag in filterTags" :key="tag" :class="{ 'tag-active': currentTag === tag }"
            ...
            <div class="content-layout">
                ...
                <section class="poetry-list">
                    <div v-for="poem in filteredPoems" :key="poem.id" class="poem-item glass-card"
                        :class="{ active: selectedPoem?.id === poem.id }" @click="selectPoem(poem)">
                ...
                <section class="poetry-detail glass-card" v-if="selectedPoem">
                    ...
                    <div class="appreciation-section" v-if="selectedPoem.appreciation">
                ...
                <div class="empty-detail glass-card" v-else>
        ...
        <el-dialog v-model="showCard" title="名句卡片生成器" width="900px" center class="card-dialog" destroy-on-close>
            <div class="card-generator-layout">
                ...
                <div class="selection-side">
                    <div class="config-group">
                        ...
                        <el-scrollbar max-height="300px">
                            <div class="line-selector">
                                <div v-for="(line, idx) in selectedPoem?.content" :key="idx" class="line-option"
                    ...
                    <div class="config-group">
                        ...
                        <div class="card-styles">
                            <span v-for="(c, idx) in bgOptions" :key="idx" :style="{ background: c }" class="color-dot"
                ...
                <div class="preview-side">
                    <div class="card-preview-area">
                        <div class="poem-card-preview" id="poetry-card" :style="{ background: cardBg }">
                            <div class="card-inner">
                                <div class="card-watermark-bg" v-if="cardBg.includes('ffffff')"></div>
                                <div class="card-body">
                                    <div class="card-quote"
                                        ...
                                        <div v-for="(l, i) in cardForm.selectedLines" :key="i" class="quote-line-group">
                                            <div v-for="(segment, si) in formatLineSegments(l)" :key="si"
                                                class="quote-segment">
                                                {{ segment }}
                                            </div>
                                        </div>
                                        <div v-if="cardForm.selectedLines.length === 0" class="placeholder-text">请选择诗句预览
                                        </div>
                                    </div>
                                    <div class="card-info">
                                ...
                                <div class="card-footer" v-if="cardForm.showWatermark || cardForm.showSeal">
                                    <div class="footer-left" v-if="cardForm.showWatermark">由 LRM工具箱 · 诗词赏析 生成</div>
                                    <div class="footer-seal" v-if="cardForm.showSeal">赏析</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <template #footer>
                <div class="dialog-footer-btns">
                    ...
                    <el-button type="primary" size="large" @click="downloadCard"
...
const filteredPoems = computed(() => {
    return poems.filter(p => {
        const matchesSearch = p.title.includes(searchQuery.value) ||
