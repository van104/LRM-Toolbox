        ...
        <main class="main-content">
            <header class="search-section glass-card">
                ...
                <div class="filter-tags">
                    <el-tag v-for="tag in filterTags" :key="tag" :type="currentTag === tag ? 'primary' : 'info'"
        ...
        <el-dialog v-model="showCard" title="名句卡片生成器" width="800px" center class="card-dialog">
                    ...
                    <el-scrollbar max-height="400px">
                        <div class="line-selector">
                            <el-checkbox-group v-model="cardForm.selectedLines">
                                <el-checkbox v-for="(line, idx) in selectedPoem?.content" :key="idx" :label="line"
                                    class="line-checkbox">
                                    {{ line }}
                                </el-checkbox>
                            </el-checkbox-group>
                        ...
                        <div class="poem-card-preview" id="poetry-card" :style="{ background: cardBg }">
                            <div class="card-inner">
                                ...
                                <div class="card-footer" v-if="cardForm.showWatermark || cardForm.showSeal">
                                    <div class="footer-left" v-if="cardForm.showWatermark">LRM工具箱 · 诗词赏析</div>
            ...
            <template #footer>
                <div class="card-styles">
                    <span v-for="c in bgOptions" :key="c" :style="{ background: c }" class="color-dot"
