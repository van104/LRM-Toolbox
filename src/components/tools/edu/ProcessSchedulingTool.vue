            ...
            <section class="card panel-grid">
                <div class="controls-left">
                    <div class="flex-row">
                        ...
                        <div class="control-group">
                            <label>进程数：</label>
                            <input v-model.number="processCount" type="number" min="1" max="26" class="num-input">
                            <button class="btn btn-primary" @click="genDefault(processCount)">生成</button>
                        </div>
                    </div>

                    
                    <div v-if="selectedAlgo === 'RR'" class="algo-options">
                        <div class="flex-row">
                            <label>时间片 q：</label>
                    ...
                    <div class="flex-row speed-control">
                        ...
                        <input v-model.number="speed" type="range" min="0.2" max="2" step="0.1" class="slider">
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr v-for="(p, idx) in processes" :key="idx">
                                ...
                                <td><input v-model.number="p.arrival" type="number" min="0" class="table-input"></td>
                                <td><input v-model.number="p.service" type="number" min="1" class="table-input"></td>
                ...
                <div class="gantt-section">
                    ...
                    <div class="gantt-wrap">
                        <div class="gantt-chart">
                            <div
v-for="(seg, i) in displayedTimeline" :key="i" class="gantt-seg" :style="{
                                width: seg.width,
