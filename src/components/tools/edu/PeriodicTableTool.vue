    ...
    <div class="periodic-table-tool">
        ...
        <main class="main-content">
            ...
            <div class="table-legend glass-card">
                <div
v-for="(cat, name) in categories" :key="name" class="legend-item"
                    @mouseenter="hoverCategory = name" @mouseleave="hoverCategory = null">
            ...
            <div class="table-container glass-card">
                <div class="periodic-grid">
                    <div
v-for="el in elements" :key="el.number" class="element-cell"
            ...
            <el-dialog
v-model="dialogVisible" :title="`${selectedElement?.name} (${selectedElement?.symbol})`"
                width="400px" center>
                <div v-if="selectedElement" class="el-detail">
                    ...
                    <div class="detail-info">
                        <div class="info-row"><span>分类</span> <b>{{ categories[selectedElement.category].label }}</b>
                        </div>
                        <div class="info-row"><span>原子量</span> <b>{{ selectedElement.weight }}</b></div>
                        <div class="info-row"><span>电子排布</span> <b>{{ selectedElement.config }}</b></div>
                        <div class="info-row"><span>发现史</span>
