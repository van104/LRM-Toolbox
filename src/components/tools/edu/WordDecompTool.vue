  ...
  <div class="word-decomp-tool">
    ...
    <main class="main-content">
      <div class="tool-card glass-card">
        ...
        <div v-else-if="inputText" class="empty-state">正在查找或未收录此字...</div>
      </div>
    </main>

    <footer class="footer">© 2026 LRM工具箱 - 拆字组词工具</footer>
  </div>
</template>
