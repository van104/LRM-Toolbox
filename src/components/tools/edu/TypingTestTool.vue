    ...
    <div class="tool-page">
        <header class="tool-header">
            ...
            <div class="header-right">
                <el-button @click="resetTest"><el-icon>
                        <Refresh />
...
const codeSnippets = "const let var function return import export default class extends constructor super this if else for while switch case break continue try catch throw new delete typeof instanceof void await async Promise".split(' ')
