...
const spawnEnemy = () => {
    ...
    switch (edge) {
        case 0: x = Math.random() * width; y = -ENEMY_RADIUS; break;
        case 1: x = width + ENEMY_RADIUS; y = Math.random() * height; break;
        case 2: x = Math.random() * width; y = height + ENEMY_RADIUS; break;
        case 3: x = -ENEMY_RADIUS; y = Math.random() * height; break;
    }
