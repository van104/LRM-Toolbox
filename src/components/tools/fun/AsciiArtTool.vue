    ...
    <div class="tool-page">
        ...
        <div class="tool-content">
            <div class="tabs-header">
                <button :class="['tab-btn', { active: currentTab === 'text' }]" @click="currentTab = 'text'">🔤 文字
                    Banner</button>
                <button :class="['tab-btn', { active: currentTab === 'image' }]" @click="currentTab = 'image'">🖼️
                    图片字符画</button>
            </div>
            ...
            <div class="layout-container">
                ...
                <aside class="config-panel">
                    ...
                    <div v-if="currentTab === 'text'" class="config-group">
                        ...
                        <div class="config-item">
                            ...
                            <el-select v-model="textConfig.font" placeholder="Select Font" @change="genTextBanner">
                        ...
                        <div class="config-item">
                            ...
                            <el-radio-group v-model="textConfig.horizontalLayout" size="small" @change="genTextBanner">
                    ...
                    <div v-if="currentTab === 'image'" class="config-group">
                        ...
                        <div class="config-item">
                            <el-checkbox v-model="imgConfig.inverted" @change="genImageAscii">反色
                ...
                <main class="result-panel">
                    ...
                    <div class="result-wrapper" :class="{ 'image-mode': currentTab === 'image' }">
                        ...
                        <div v-if="!resultText" class="placeholder-text">
                            预览将在这里显示...
                        </div>
                    </div>
                </main>
