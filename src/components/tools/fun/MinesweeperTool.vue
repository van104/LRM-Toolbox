<template>
  <div class="minesweeper-tool">
            ...
            <div class="board" :style="boardStyle">
              <div v-for="(row, y) in board" :key="y" class="board-row">
                <div
                  ...
                  @mousedown="handleMouseDown($event, x, y)"
                  @mouseup="handleMouseUp"
                >
                  <span v-if="cell.revealed && cell.mine" class="mine">💣</span>
                  <span
                    v-else-if="cell.revealed && cell.adjacentMines > 0"
                    class="number"
              ...
              <div class="difficulty-selector">
                ...
                >
                  ...
                  <span class="diff-info"
                    >{{ diff.cols }}×{{ diff.rows }} · {{ diff.mines }}雷</span
                  >
                </button>
              </div>
            </div>
    ...
    <footer class="footer">© 2026 LRM工具箱 - 扫雷游戏</footer>
  </div>
</template>
