<template>
  <div class="jigsaw-tool">
      ...
      <div class="layout-grid" :class="{ 'settings-collapsed': !settingsExpanded }">
        <div ref="gameArea" class="game-section glass-card">
          <div class="game-header">
            ...
            <div class="progress-info">已拼: {{ solvedCount }} / {{ totalPieces }}</div>
          </div>
          ...
          <div class="game-controls">
            ...
            <button
              class="control-btn"
              :disabled="isGameComplete || loading"
              @click="scatterPieces"
            >
              <el-icon>
                <RefreshRight />
          ...
          <div v-show="settingsExpanded" class="settings-section glass-card">
            ...
            <div class="settings-group">
              ...
              <div class="image-selector">
                ...
                <div
                  class="img-option upload-option"
            ...
            <div class="settings-group">
              ...
              <div class="piece-count-preview">共 {{ difficulty * difficulty }} 片</div>
            ...
            <div class="settings-group">
              ...
              <div class="difficulty-options">
                <span
                  ...
                  :key="opt.value"
                  class="text-option"
                  :class="{ active: snapDistance === opt.value }"
                  @click="snapDistance = opt.value"
                >
                  {{ opt.label }}
                </span>
              </div>
    ...
    <footer class="footer">© 2026 LRM工具箱 - 拼图游戏</footer>
  </div>
</template>
...
<script setup>
  ...
  const presetImages = [
    {
      ...
      thumb:
        'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&w=100&q=60'
    },
    {
      title: '城市',
      url: 'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=800&q=80',
      thumb:
        'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=100&q=60'
    },
    {
      title: '猫咪',
      url: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=800&q=80',
      thumb:
        'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=100&q=60'
    },
    {
      title: '抽象',
      url: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?auto=format&fit=crop&w=800&q=80',
      thumb:
        'https://images.unsplash.com/photo-1541701494587-cb58502866ab?auto=format&fit=crop&w=100&q=60'
    }
  ];
  ...
  const isGameComplete = computed(
    () => solvedCount.value === totalPieces.value && totalPieces.value > 0
  );
  ...
  const startDrag = pos => {
    ...
    for (const piece of sortedPieces) {
      ...
      if (
        pos.x >= piece.x + 10 &&
        pos.x <= piece.x + piece.width - 10 &&
        pos.y >= piece.y + 10 &&
        pos.y <= piece.y + piece.height - 10
      ) {
