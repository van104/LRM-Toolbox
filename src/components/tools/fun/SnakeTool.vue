...
const skins = [
    {
        id: 'retro', name: '经典复古',
        snakeHead: '#2e7d32', snakeBody: '#4caf50',
        food: '#e53935', bg: '#e0e0e0', grid: 'rgba(0,0,0,0.05)',
        shadow: 'none'
    },
    {
        id: 'neon', name: '赛博霓虹',
        snakeHead: '#00f2fe', snakeBody: '#4facfe',
        food: '#f093fb', bg: '#090919', grid: 'rgba(79, 172, 254, 0.1)',
        shadow: '0 0 10px'
    },
    {
        id: 'gold', name: '黑金奢华',
        snakeHead: '#ffd700', snakeBody: '#daa520',
        food: '#fff', bg: '#000000', grid: 'rgba(255, 215, 0, 0.1)',
        shadow: '0 0 5px'
    }
];
...
function getSnakeStyle(segment, index) {
    return {
        ...
        boxShadow: index === 0 ? currentSkin.value.shadow + ' ' + currentSkin.value.snakeHead : 'none',
        zIndex: index === 0 ? 10 : 5
    };
}
...
function changeDirection(dir) {
    ...
    const isOpposite = (dir.x !== 0 && dir.x === -direction.value.x) ||
...
function handleKeydown(e) {
    ...
    switch (e.code) {
        ...
        case 'Space': toggleBoost(true); break;
        case 'KeyP': togglePause(); break;
        case 'KeyR': if (gameOver.value) startGame(); break;
    }
}
