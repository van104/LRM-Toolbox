<template>
  <div class="ai-draw-guess">
          ...
          <div class="settings-grid">
            ...
            <div class="form-item">
              ...
              <input
                ...
                :placeholder="
                  hasBuiltInKey
                    ? '已启用内置密钥 (可在此输入自定义 Key 覆盖)'
                    : '输入 ' + (currentProvider?.name || '') + ' 的 API Key'
                "
              />
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
              ...
              <input
                ...
                type="text"
                placeholder="例如: Qwen/Qwen2-VL-72B-Instruct"
              />
            </div>
          </div>
        ...
        <div class="result-sidebar">
          ...
          <div class="info-card glass-card">
            ...
            <div class="info-content">
              <p>
                <strong>AI 驱动：</strong> 本工具接入了视觉大模型（如
                Qwen-VL），它拥有一双"慧眼"，能看懂您画的线条和形状。如您需要撤销操作，可以点击下方的“撤销”按钮。
              </p>
              <p>如果您需要使用其他模型可在设置中配置。</p>
              <p>
                <strong>隐私安全：</strong> 支持双模式运行。配置自定义 Key
                时为直连模式，密钥仅保存在本地；使用内置服务时为代理模式，通过后端安全转发，保障密钥不泄露。
              </p>
              <p>
                <strong>小贴士：</strong> 尽量抓住物体的特征来画。如果 AI
                猜不出来，不妨给它一点颜色看看（使用彩色画笔）！
              </p>
            </div>
          </div>
        </div>
    ...
    <footer class="footer">© 2026 LRM工具箱 - AI 视觉交互实验室</footer>
  </div>
</template>
...
<script setup>
  ...
  const config = reactive({
    ...
    apiUrl:
      localStorage.getItem('ai_guess_api_url') || 'https://api.siliconflow.cn/v1/chat/completions',
          ...
          messages: [
            {
              ...
              content: [
                {
                  type: 'text',
                  text: '请猜测这张手绘画出的是什么物体？只回复物体名称关键词，不要多余解释。不要深度思考，快速回答。'
                },
