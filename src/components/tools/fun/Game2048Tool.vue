            ...
            <div class="container">
                ...
                <div class="above-game">
                    ...
                    <div class="game-actions">
                        <button class="undo-button" @click="undo" :disabled="gameHistory.length === 0" title="撤销步数">
                            撤销
                        </button>
                ...
                <div class="game-container" :class="'size-' + size">
                    <div class="game-message" :class="gameStatusClass">
                        <p>{{ gameStatusText }}</p>
                        <div class="lower">
                            <button class="keep-playing-button" @click="continueGame"
                                v-if="gameWon && !keepPlaying">继续挑战</button>
                    ...
                    <div class="tile-container">
                        <div v-for="tile in tiles" :key="tile.id" class="tile" :class="getTileClasses(tile)"
                        ...
                        <div class="settings-content">
                            <div class="setting-item">
                                ...
                                <div class="size-selector">
                                    <button v-for="s in [4, 5, 6]" :key="s" class="size-btn"
