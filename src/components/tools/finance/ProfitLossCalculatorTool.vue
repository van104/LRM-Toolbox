            ...
            <div class="layout-container">
                ...
                <section class="calc-panel">
                    <div class="glass-card">
                        ...
                        <el-button type="primary" class="calc-btn" size="large" @click="calculate">开始测算</el-button>
                    </div>
...
const calculate = () => {
    ...
    const changePercent = currentPrice.value !== 0 ? ((avgCost - currentPrice.value) / currentPrice.value) * 100 : 0
