                ...
                <div class="results-area" v-if="result">
                    ...
                    <section class="analysis-box glass-card">
                        ...
                        <div class="analysis-content">
                            ...
                            <p>2. <b>个人账户养老金</b>：个人账户储存额除以计发月数（60岁为139个月，55岁为170个月）。</p>
                            <p class="warning-text">* 以上结果基于当前政策和静态数据估算，未考虑通货膨胀及未来工资水平和平均月薪的动态增长。仅供参考。</p>
                        </div>
                    </section>
                </div>
            </div>
...
const calculate = () => {
    ...
    const basePension = (avgSocialSalary.value + avgSocialSalary.value * clampedIndex) / 2 * totalPaidYears * 0.01
