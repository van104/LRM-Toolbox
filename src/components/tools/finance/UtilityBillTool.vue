  ...
  <div class="utility-bill-tool">
    ...
    <main class="main-content">
      ...
      <div class="bill-card glass-card">
        ...
        <div class="result-display">
          <div class="total-row">
            <span>预计费用</span>
            <div class="total-price"><small>¥</small>{{ formatMoney(result.total) }}</div>
          </div>
    ...
    <div class="disclaimer-wrap" style="max-width: 500px; margin: 0 auto; padding: 0 1.5rem 2rem">
      ...
      >
        ...
        <span
          >本计算器结果仅供个人预算参考。由于阶梯计费的具体起始日期、公摊政策及各地单价差异，最终账单请以供给单位出具的缴费单为准。</span
        >
      </div>
    </div>

    <footer class="footer">© 2026 LRM工具箱 - 电费/水费计算器</footer>
  </div>
</template>
