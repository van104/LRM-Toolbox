...
export const tools: Tool[] = [
  {
    ...
    description:
      '支持 JSON 格式化美化、压缩混淆、语法校验、树形视图展示等功能。可自动检测和修复常见 JSON 语法错误。',
    usage:
      '1. 将 JSON 数据粘贴到左侧编辑器\n2. 点击格式化按钮美化代码\n3. 可选择不同缩进风格和排序方式',
  ...
  },
  {
    ...
    description:
      '支持自定义长度、字符类型（大小写/数字/符号），提供强度检测、历史记录和批量生成功能。优先使用加密级随机数生成器。',
    usage: '1. 设置密码长度和字符选项\n2. 点击生成按钮\n3. 复制密码或保存到历史',
  ...
  },
  {
    ...
    description:
      '支持 Java/JavaScript/C# 字符串转义，HTML/XML 实体编码，以及 SQL、URL、CSV 等多种格式的互相转换。',
    usage: '1. 输入或粘贴原始文本\n2. 选择目标语言\n3. 点击转义或反转义',
  ...
  },
  {
    ...
    description:
      '专业的 SQL 构建工具：支持列表转 IN 查询、CSV 转 INSERT 插入、JSON 转 CREATE 建表，以及智能解析 SQL 文件生成 Mock 测试数据。',
  ...
  },
  {
    ...
    description:
      '轻量级在线版本的 Postman。支持 GET, POST, PUT, DELETE 等常用请求方法，可配置 Header、Query 参数及 JSON/Form Body，提供语法高亮显示和结果耗时统计。',
    usage:
  ...
  },
  {
    ...
    description:
      '在线解析 JSON Web Token (JWT)。支持 Base64Url 编码的 Header 和 Payload 实时解析显示，自动识别过期时间 (exp)，界面红绿分明，语义清晰。',
    usage:
  ...
  },
  {
    ...
    description:
      '可视化生成 Crontab 表达式。支持分、时、日、月、周的精细化配置，提供实时语义化中文解读及常用定时任务模板，解决记不住 Cron 语法的烦恼。',
    usage:
      '1. 在各个标签页（分、时、日等）选择执行频率\n2. 左侧实时预览生成的表达式及中文描述\n3. 点击复制以便在服务器上使用',
    route: '/tools/crontab',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '涵盖 Git 基础配置、分支操作、暂存提交、撤销回滚、远程同步及 Stash 等核心命令。提供语义化的详细说明和一键复制功能，支持实时快速模糊搜索。',
    usage:
  ...
  },
  {
    ...
    description:
      '在线解析 PEM 格式的 SSL 证书。支持提取 Common Name (CN)、颁发机构 (Issuer)、有效期 (Not Before/After) 及序列号等核心属性。本地解析，保障数据隐私。',
    usage:
      '1. 将证书文件 (.crt/.pem) 的内容粘贴到输入框\n2. 右侧自动显示该证书的详细注册信息及过期状态提醒',
  ...
  },
  {
    ...
    description:
      '快速生成常见的开发运维配置文件。包含 Nginx 反向代理、静态资源托管、Docker Compose 常用服务（Node/MySQL）等，支持参数化自定义字段并一键复制。',
    usage:
      '1. 选择左侧需要的模版类型（如 Nginx 反向代理）\n2. 在输入框中修改域名、端口等自定义参数\n3. 右侧实时预览生成的配置文件内容，点击复制即可',
  ...
  },
  {
    ...
    description:
      '支持透明度的颜色选择器，实时预览并自动转换为 HEX, HEX8, RGB, HSL 等常用格式，一键复制。',
  ...
  },
  {
    ...
    summary: '矢量图标一站式搜索下载',
    description:
      '聚合全球主流矢量图标库（Iconfont, Font Awesome, Remix Icon等），提供官网直达与便捷的聚合搜索功能，设计开发必备。',
    usage:
      '1. 在上方搜索框输入关键词（如 "home"）。\n2. 点击对应卡片下方的"搜索"按钮，直接跳转至该平台的搜索结果页。\n3. 或点击"访问官网"浏览全部资源。',
  ...
  },
  {
    ...
    description:
      '精选 Google Fonts, 字由, 100font 等优质字体资源站，提供免费商用字体下载指引和 WebFont 在线引用服务。',
    usage:
      '1. 输入字体名称关键词（如 "Roboto"）。\n2. 使用一键跳转功能在各平台搜索。\n3. 或直接访问平台浏览最新字体。',
  ...
  },
  {
    ...
    description:
      '聚合 Figma, Sketch, Adobe XD, Pixso, 即时设计等主流 UI/UX 设计工具，提供官方网站入口。',
    usage: '1. 浏览工具列表\n2. 点击“访问官网”跳转至对应平台\n3. 开始您的设计工作',
  ...
  },
  {
    ...
    description:
      '聚合 Unsplash, Pexels, Pixabay, Freepik, Dribbble, Behance 等优质设计资源站，一站式获取灵感与素材。',
    usage:
      '1. 选择需要的素材类型（图片/矢量/灵感）\n2. 点击卡片上的按钮跳转至对应网站\n3. 搜索或下载所需资源',
  ...
  },
  {
    ...
    description:
      '支持 UUID/GUID、随机字符串、数字、颜色生成；提供中英文假文（Lorem Ipsum）、姓名/地址/身份证等个人信息模拟，以及基于 Mock.js 模板的复杂 JSON 数据生成。',
    usage: '1. 选择数据类型标签\n2. 设置生成参数（数量/规则）\n3. 点击生成并复制结果',
  ...
  },
  {
    ...
    description:
      '集成 Figlet 库将文字转换为 3D/手写体字符画，支持多种字体；同时提供图片转 ASCII 字符画功能，支持自定义字符集和分辨率。',
  ...
  },
  {
    ...
    summary: '经典五子棋对弈游戏',
    description:
      '支持人机对战与双人对弈两种模式。可自由选择棋盘大小（9×9 至 19×19）、先后手以及 AI 难度。简洁优雅的棋盘界面，后续将支持对接 AI 模型 API。',
  ...
  },
  {
    ...
    description:
      '经典的井字棋游戏，支持人机对战与双人对弈。AI 采用 Minimax 算法，困难模式下几乎不可战胜！',
    usage: '1. 选择游戏模式（人机/双人）\n2. 设置先后手和 AI 难度\n3. 点击格子落子',
  ...
  },
  {
    ...
    summary: '经典逻辑排雷游戏',
    description:
      '经典的扫雷游戏，支持初级（9×9）、中级（16×16）、高级（30×16）三种难度，还可自定义棋盘大小和地雷数量。支持右键插旗、双键快揭等经典操作。',
    usage: '1. 选择难度\n2. 左键揭开格子，右键插旗\n3. 根据数字推理找出所有地雷',
  ...
  },
  {
    ...
    summary: '自定义图片拼图游戏',
    description:
      '支持自定义上传图片生成拼图，提供多种难度选择（3x3 到 10x10）。经典的拼图玩法，自动吸附对齐，记录通关时间。',
  ...
  },
  {
    ...
    description:
      '经典的 Wordle 风格猜词游戏，支持英文单词（5字母）和中文成语（4字）两种模式。包含每日挑战逻辑统计和无限练习模式。',
    usage:
  ...
  },
  {
    ...
    summary: '测试视觉与点击反应速度',
    description:
      '专业的视觉反应速度测试工具。等待红色变为绿色时立即点击，系统将精确记录您的毫秒级反应时间，并提供全球排名模拟对比。',
    usage: '1. 点击蓝色区域开始测试\n2. 等待背景由红变绿\n3. 变绿瞬间立即点击\n4. 查看成绩和排名',
  ...
  },
  {
    ...
    summary: '经典数独益智游戏',
    description:
      '经典的9x9数独益智游戏。支持简单/中等/困难三种难度，包含笔记功能、自动校验、提示系统和计时器。',
    usage:
      '1. 选择难度开始新游戏\n2. 点击格子选中，再点击数字填入\n3. 使用笔记功能记录可能的数字\n4. 利用提示和检查功能辅助解题',
    route: '/tools/sudoku',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '经典的记忆翻牌游戏。在有限的步数和时间内，通过记忆卡片位置，找出所有相同的配对。支持 4x4 和 6x6 两种难度模式。',
    usage: '1. 点击卡片将其翻转\n2. 连续翻出两张相同的卡片即可消除\n3. 消除所有卡片即可通关',
  ...
  },
  {
    ...
    summary: '经典的数学逻辑益智游戏',
    description:
      '汉诺塔（Tower of Hanoi）是一个著名的数学谜题。目标是将所有圆盘从起始柱移动到目标柱，每次只能移动一个圆盘，且大圆盘不能放在小圆盘上。',
    usage:
      '1. 点击柱子选择最上方的圆盘\n2. 点击另一个柱子将其放入\n3. 将所有圆盘移至最右侧柱子即可胜利',
    route: '/tools/tower-hanoi',
    isLocal: true,
  ...
  },
  {
    ...
    summary: '极简风格的飞行闯关游戏',
    description:
      '控制小鸟飞行，穿过随机生成的管道障碍。看似简单，实则极具挑战性！考验你的反应速度和节奏感。',
    usage:
  ...
  },
  {
    ...
    summary: '经典的消除类益智游戏',
    description:
      '休闲解压的消消乐游戏。交换相邻的图标，凑齐3个或以上相同图标即可消除得分。支持连击奖励。',
    usage:
  ...
  },
  {
    ...
    summary: '策略塔防游戏',
    description:
      '经典的塔防小游戏。建造防御塔，阻止敌人到达终点。拥有不同类型的防御塔和无限的敌人波次。',
    usage: '1. 点击右侧面板选择防御塔\n2. 点击地图空白区域建造\n3. 点击“下一波敌人”开始战斗',
  ...
  },
  {
    ...
    summary: '经典方块消除游戏',
    description:
      '重温经典的俄罗斯方块游戏！支持方块旋转、快速/直接下落、暂存功能（Hold）。包含等级系统，随着分数增加游戏速度逐渐加快。',
  ...
  },
  {
    ...
    summary: '3D 迷宫探索游戏',
    description:
      '使用 Three.js 构建的 3D 迷宫探索游戏。在错综复杂的迷宫中寻找出口，挑战不同难度和关卡。',
  ...
  },
  {
    ...
    summary: '桌面像素电子宠物',
    description:
      '重温童年回忆的电子宠物。你需要喂食、陪玩、清理，精心照顾它从一颗蛋进化成成体。包含丰富的表情交互和状态系统。',
    usage: '1. 点击蛋孵化\n2. 定时喂食和玩耍保持状态\n3. 及时清理便便以免生病\n4. 长期照顾可以进化',
  ...
  },
  {
    ...
    summary: '沉浸式互动小说',
    description:
      '基于选择的互动小说游戏。可以在武侠、奇幻等多种背景中展开冒险，你的每一个选择都会影响剧情走向和最终结局。',
    usage:
      '1. 选择一个剧本开始游戏\n2. 阅读剧情并做出选择\n3. 管理你的生命值和金币\n4. 达成不同结局',
  ...
  },
  {
    ...
    summary: '文字版人生模拟器',
    description:
      '从出生到老去的完整人生模拟。每一次点击都是一年，包含随机事件、职业选择、资产管理等元素。你的天赋决定起点，但选择决定终点。',
    usage:
      '1. 随机生成初始天赋\n2. 每年点击"下一年"推进时间\n3. 处理发生的随机事件\n4. 努力工作赚钱，保持健康快乐',
  ...
  },
  {
    ...
    summary: '经典弹球/打砖块游戏',
    description:
      '一款物理特效精美的经典弹球游戏。通过移动挡板反弹小球，消除所有关卡中的砖块。包含多种砖块类型和关卡设计。',
  ...
  },
  {
    ...
    summary: '数字合并益智游戏',
    description:
      '经典的 2048 数字游戏。滑动方向键合并相同的数字块，挑战合成 2048！支持 4×4、5×5、6×6 多种规格棋盘。',
  ...
  },
  {
    ...
    description:
      '通过 Mustache 风格占位符 ({{var}}) 和 JSON/CSV 数据源，批量生成结构化文本。支持实时变量提取与自定义分隔符拼接。',
    usage: '1. 编写模板 ({{var}})\n2. 粘贴 JSON/CSV 数据\n3. 生成并复制结果',
...

  {
    ...
    description:
      '提供去重、去空行、去空格、排序、大小写转换、全半角转换、标点规整等多种文本处理功能，支持批量操作。',
    usage: '1. 输入或粘贴文本\n2. 点击中间的功能按钮进行处理\n3. 实时预览结果并一键复制',
  ...
  },
  {
    ...
    description:
      '专业的文本信息提取工具，支持一键提取邮箱、URL、手机号、身份证、IP地址等常用信息，同时支持自定义正则表达式提取和关键词行过滤。',
    usage: '1. 输入或粘贴源文本\n2. 点击中间的提取按钮或输入正则\n3. 查看并复制提取结果',
  ...
  },
  {
    ...
    description:
      '集简繁转换、拼音标注、数字金额大写、进制转换、URL/Unicode 编码转换于一体的多功能文本处理工具。',
    usage: '1. 输入文本\n2. 点击中间的转换按钮\n3. 结果显示在右侧',
  ...
  },
  {
    ...
    description:
      '强大的文本结构化工具，支持按分隔符或长度拆分文本、自定义拼接、CSV 列提取及列表格式转换。',
  ...
  },
  {
    ...
    summary: '高效的文本差异对比工具',
    description:
      '支持按行/词/字符三种模式比较，提供合并/并排双视图，实时统计差异，支持文件导入导出及差异点自动跳转。',
  ...
  },
  {
    ...
    summary: '批量图片文件重命名工具',
    description:
      '支持批量导入图片，自定义前缀、添加序号/时间戳、格式转换（WebP等），支持单个文件独立命名及实时预览。',
    usage:
      '1. 拖拽或点击上传图片\n2. 设置重命名规则（前缀、后缀、格式）\n3. 可手动修改个别文件名\n4. 点击批量下载',
  ...
  },
  {
    ...
    description:
      '开启您的云端音频库。支持 MP3, WAV, OGG, M4A, FLAC, AAC 等常见音频格式。提供永久存储、历史记录管理、公开/私有权限设置等完整功能。',
    usage:
      '1. 拖拽或点击上传音频文件\n2. 管理我的音频列表\n3. 生成分享链接或下载\n4. 支持公开/私有权限控制',
    isLocal: false,
  ...
  },
  {
    ...
    description:
      '支持生成 EAN, UPC, Code128, ITF, MSI, Pharmacode 等多种格式条形码，支持自定义尺寸、颜色和显示文本。',
    usage: '1. 输入条码内容\n2. 选择条码格式\n3. 调整尺寸和颜色\n4. 下载图片',
  ...
  },
  {
    ...
    description:
      '专业的图片格式转换工具，支持批量将图片转换为 PNG, JPG, WEBP 格式，支持自定义压缩质量。',
    usage: '1. 上传或拖拽图片文件\n2. 选择目标格式和质量\n3. 点击转换并下载',
  ...
  },
  {
    ...
    description:
      '支持按百分比缩放或指定像素宽高调整图片尺寸，支持锁定纵横比与批量处理，提供即时质量预览。',
    usage:
      '1. 上传图片\n2. 设置缩放模式（百分比/固定尺寸）\n3. 调整参数预览效果\n4. 开始处理并下载',
  ...
  },
  {
    ...
    summary: '批量添加文字或图片水印',
    description:
      '支持批量添加文字水印或图片水印。可自定义位置、透明度、旋转角度、缩放比例。支持全屏平铺模式，所有处理均在本地完成。',
    usage:
      '1. 上传一张或多张图片\n2. 选择“文字”或“图片”水印模式\n3. 调整位置、透明度、旋转等参数\n4. 预览无误后点击批量下载',
  ...
  },
  {
    ...
    summary: '横向、纵向或网格拼图',
    description:
      '支持将多张图片拼接为一张长图或拼图。提供纵向拼接、横向拼接以及智能网格模式，支持自定义外边距、图片间距、圆角以及背景颜色。',
    usage:
      '1. 上传多张图片\n2. 选择拼接模式（纵向/横向/网格）\n3. 调整间距、圆角与背景色\n4. 点击导出生成的拼图',
  ...
  },
  {
    ...
    summary: 'AI 自动去除图片背景',
    description:
      '集成主流 AI 抠图引擎。支持一键去除人物、动物、商品等主体背景，生成透明 PNG 图片。支持 Remove.bg 及自定义 API 服务商配置。',
    usage: '1. 上传图片\n2. 在右侧设置面板配置 API Key\n3. 点击“开始抠图”并下载结果',
  ...
  },
  {
    ...
    summary: '照片排版与创意拼贴制作',
    description:
      '专业的照片书页排版工具。支持多种网格布局、自由拼贴模式，可添加背景纹理、贴纸素材和文字标题。导出高清图像，适合打印画册或社交分享。',
    usage:
      '1. 选择布局模版或自由模式\n2. 上传并拖拽照片到指定区域\n3. 调整位置、旋转及素材装饰\n4. 生成并下载高分辨率图片',
...

  {
    ...
    description:
      '支持导入 Excel/CSV 数据，生成柱状图、折线图、饼图等多种图表。支持数据在线编辑、即时预览，并可导出高清图片。',
...

  {
    ...
    description:
      '支持长度、重量、温度、面积、体积、时间、速度、数据、压强、能量、功率、角度等单位互转，包含中国传统单位。',
    usage: '1. 选择单位类别\n2. 输入数值和源单位\n3. 选择目标单位查看结果',
  ...
  },
  {
    ...
    description:
      '提供专业训练倒计时（支持组间休息）、训练计划管理（自定义动作/组数）以及自由通用计时器功能。',
    usage: '1. 创建或选择训练计划\n2. 开始训练并跟随倒计时\n3. 也可使用自由计时模式进行通用计时',
  ...
  },
  {
    ...
    description:
      '支持全球主流货币的实时汇率换算，提供最近30天汇率走势图，支持快捷货币对切换和结果分享，适合海淘、旅行和跨境结算场景。',
    usage:
      '1. 选择源货币和目标货币\n2. 输入金额，自动计算结果\n3. 点击互换按钮可反向计算\n4. 查看下方趋势图了解近期走势',
  ...
  },
  {
    ...
    description:
      '支持二、八、十、十六进制实时互转，内置 ASCII 码对照表，适合程序员、电子爱好者和计算机学生使用。',
    usage:
      '1. 在任意进制输入框中输入数值\n2. 其他进制将自动计算并更新\n3. 点击复制按钮可复制结果\n4. 下方可查找 ASCII 码',
  ...
  },
  {
    ...
    description:
      '支持 FCFS、SJF、SRTF、RR、Priority 等多种调度算法的可视化演示。动态生成甘特图，计算周转时间与带权周转时间，支持自定义进程与动画播放。',
    usage:
      '1. 选择调度算法（如 FCFS, RR）\n2. 设置进程数量与参数（到达/服务时间）\n3. 点击运行查看甘特图与结果\n4. 可播放执行动画',
  ...
  },
  {
    ...
    description:
      '专业的服装鞋帽尺码转换工具，涵盖男装、女装、童装及鞋码。支持中国国标、欧美、日韩等国际标准互转，助您海淘购物无忧。',
    usage:
      '1. 选择类别（男/女/童/鞋）\n2. 选择您当前的标准和已知尺码\n3. 即时查看对应国家/地区的标准尺码\n4. 下方提供完整对照表供参考',
  ...
  },
  {
    ...
    summary: '日期间隔计算与推算',
    description:
      '专业的日期时间计算工具。支持计算两个日期之间的天数、月数、周数；也支持根据基准日期向前或向后推算新的日期。适用倒计时、工龄计算、纪念日查询。',
    usage:
      '1. 间隔计算：选择开始与结束日期，查看详细时间差\n2. 日期推算：选择基准日期，输入增减天数，获取新日期',
  ...
  },
  {
    ...
    description:
      '重要的日子不再错过。记录亲友生日、结婚纪念日或重要节日，自动计算倒计时天数、虚岁/周岁，并按时间自动排序，直观展示剩余天数。',
    usage:
      '1. 点击添加按钮，输入事件名称和日期\n2. 自动计算下次发生时间的倒计时\n3. 生日类型还会显示当前周岁和虚岁\n4. 临近30天内的日期会高亮显示',
  ...
  },
  {
    ...
    summary: '精准计算工期与考勤天数',
    description:
      '自动剔除周末，支持自定义节假日和补班日期。输入起止时间，即可快速计算实际工作天数。适用于项目管理、HR考勤统计及工程排期。',
    usage:
  ...
  },
  {
    ...
    summary: '公农历互转与黄历查询',
    description:
      '全面的中国传统历法工具。支持公历与农历日期的相互转换，提供每日宜忌、干支纪年、节气、生肖及星座信息，是您查看黄道吉日的好帮手。',
    usage:
      '1. 选择“公历转农历”或“农历转公历”模式\n2. 设定日期\n3. 查看对应的日期信息、宜忌、节气等详情',
  ...
  },
  {
    ...
    summary: '增强型科学计算器',
    description:
      '集成基础算术与科学计算功能。支持记忆存储（M+）、括号运算、三角函数及对数运算，界面简洁美观，完美适配日常与学习场景。',
    usage:
      '1. 可使用键盘或屏幕按钮输入\n2. 点击 "Sci" 展开科学计算面板\n3. 支持 M+/MR 等记忆功能\n4. 底部自动记录计算历史',
  ...
  },
  {
    ...
    description:
      '支持自定义选项转盘，点击随机抽取。适配“中午吃什么”、“真心话大冒险”等多种生活纠结场景。',
  ...
  },
  {
    ...
    summary: '聚合全国垃圾分类查询库',
    description:
      '专业的垃圾分类指南。涵盖可回收物、厨余垃圾、有害垃圾和其他垃圾的详细分类要求，支持快速搜索查询。',
    usage: '1. 输入垃圾名称检索分类\n2. 查看不同类别的投放要求与示例',
  ...
  },
  {
    ...
    description:
      '直观查看“哪天休、哪天补”。基于国务院发布的官方放假安排，提供倒计时与详细的调休建议。',
  ...
  },
  {
    ...
    description:
      '精选高频使用的公共服务入口。包括违章查询、社保查询、公积金、快递单号聚合等，一键跳转官方平台。',
  ...
  },
  {
    ...
    summary: '房贷月供与利息计算',
    description:
      '支持等额本息与等额本金两种方式。输入贷款金额、期限和利率，自动计算每月还款额、利息总额，并提供详细的最后还款明细表。',
    usage:
      '1. 选择还款方式（等额本息/等额本金）\n2. 输入贷款总额、年限和年利率\n3. 点击计算，查看月供分析图表和明细',
  ...
  },
  {
    ...
    summary: '工资税后收入计算',
    description:
      '2024 最新个税计算规则。支持计算实发工资、个人所得税及五险一金明细。支持自定义社保公积金缴纳比例和专项附加扣除。',
    usage:
      '1. 输入税前月薪\n2. 填写专项附加扣除总额（可选）\n3. 调整五险一金缴纳基数与比例（可选）\n4. 点击计算查看实发工资分布',
  ...
  },
  {
    ...
    summary: '购物打折与凑单助手',
    description:
      '商场购物、电商大促必备工具。支持单品折扣计算（X折/百分比）和跨店满减凑单计算（满X减Y），帮你快速算清到手价和节省金额。',
    usage:
      '1. 单品模式：输入原价与折扣，即得折后价\n2. 凑单模式：设置满减规则，添加商品列表，自动计算是否达标及凑单建议',
  ...
  },
  {
    ...
    description:
      '输入身高体重，快速计算 BMI 指数，对照中国成人标准判断偏瘦、正常、超重或肥胖，并提供健康体重范围建议。',
    usage:
      '1. 输入身高(cm)和体重(kg)\n2. 自动计算 BMI 值并显示健康等级\n3. 查看对应的健康体重范围建议',
  ...
  },
  {
    ...
    summary: '热量查询与每日消耗测算',
    description:
      '健身减肥必备。提供常见食物热量查询，支持计算每日热量消耗（TDEE），并给出减脂、维持或增肌的热量摄入建议。',
    usage:
      '1. 计算 TDEE：输入身体数据与活动量，获取每日消耗\n2. 查询热量：输入食物名称，添加至今日清单，统计总摄入',
  ...
  },
  {
    ...
    summary: '自定义范围生成随机数字',
    description:
      '支持自定义数值范围（最小值/最大值）和生成数量。可选择是否去重、是否自动排序。适用于抽奖、分组、数学练习等场景。',
    usage:
      '1. 设置数值范围（如 1-100）\n2. 输入生成数量\n3. 勾选"不重复"或"排序"（可选）\n4. 点击生成并复制结果',
  ...
  },
  {
    ...
    description:
      '在画布上尽情创作，通过硅基流动 API 调用最新的多模态大模型（如 Qwen-VL）实时猜测您的艺术作品内容。支持自定义 API 配置，纯前端运行。',
    usage:
  ...
  },
  {
    ...
    description:
      '支持将汉字转换为完整拼音。提供多种声调标注模式（符号/数字/无声调）以及“对照模式”，可为朗诵文案进行逐字注音。',
    usage: '1. 输入或粘贴汉字文本\n2. 选择声调格式和展示模式\n3. 复制结果或查看拼音对照',
    route: '/tools/pinyin',
    isLocal: true,
  ...
  },
  {
    ...
    summary: '文本大纲一键转思维导图',
    description:
      '通过 Markdown 大纲语法（# 标题，- 列表）快速自动生成精美的思维导图。支持实时预览、缩放查看及 SVG 图片导出，助您快速梳理思路。',
    usage:
      '1. 在左侧输入或粘贴 Markdown 文本\n2. 右侧实时预览思维导图\n3. 可拖拽、缩放画布\n4. 点击导出按钮保存为 SVG',
  ...
  },
  {
    ...
    description:
      '所见即所得的数学公式编辑器。支持数学、物理、化学公式的可视化输入，自动生成标准 LaTeX 代码，支持导出高清公式图片，适配文档与课件制作。',
    usage:
      '1. 在编辑器中点击输入或使用下方快捷符号\n2. 实时生成 LaTeX 代码与预览图\n3. 点击“复制”获取代码，或“导出图片”保存结果',
  ...
  },
  {
    ...
    description:
      '支持单一电价与阶梯电价两种模式。输入用量可快速计算月度费用。支持自定义阶梯档位和价格，适合租房核算与家庭记账。',
    usage:
  ...
  },
  {
    ...
    summary: '财富增长复利估算',
    description:
      '专业的财富增值计算工具。支持初始本金、定期加仓（月/年）、预期收益率的多维度复利模拟，直观展示资产随时间增长的曲线与明细。',
  ...
  },
  {
    ...
    summary: '退休养老金收入预测',
    description:
      '基于中国现行社保计算模型（基础养老金+个人账户养老金）。结合个人工资、缴费年限、社会平均工资等因素，科学预测退休后的月领金额。',
    usage:
      '1. 输入当前年龄、薪资及已缴费年限\n2. 设置预想退休年龄与当地社平工资\n3. 查看每月的预估领取金额与替代率分析',
  ...
  },
  {
    ...
    description:
      '聚合国内外主流银行定期存款利率、大额存单利率及 LPR 实时基准。支持多行利率横向对比，快速测算不同期限、不同银行的利息差异。',
    usage:
  ...
  },
  {
    ...
    summary: '持仓成本平摊与损益分析',
    description:
      '专门为股票、基金、虚拟货币投资者设计的成本测算工具。支持补仓/减仓后的平均成本重算，自动扣除交易手续费，并提供盈亏平衡点（保本价）及目标涨幅价格预演。',
    usage:
  ...
  },
  {
    ...
    summary: '体积重量与计费重量计算',
    description:
      '快速就算快递包裹的体积重量。支持自定义抛比系数（6000/5000/8000），自动对比实际重量，判断计费重量与是否为抛货，寄件发货必备。',
    usage:
      '1. 输入包裹长、宽、高 (cm)\n2. 输入实际重量 (kg)\n3. 选择抛比系数（默认 6000）\n4. 查看体积重与计费重量',
  ...
  },
  {
    ...
    summary: '屏幕像素标尺与测量工具',
    description:
      '提供可视化的水平和垂直像素标尺。支持拖拽测量，实时显示坐标像素值。适合前端工程师和 UI 设计师快速校对页面元素位置与尺寸。',
    usage:
      '1. 点击添加水平或垂直标尺\n2. 拖动标尺线至目标位置\n3. 查看实时像素坐标\n4. 双击标尺可旋转方向',
  ...
  },
  {
    ...
    summary: '姓名笔画数查询与计算',
    description:
      '输入姓名自动拆解并计算每个汉字的笔画数及总笔画。支持简体和繁体字输入，适用于学生作业自查、姓名民俗研究等场景。',
    usage: '1. 输入中文姓名\n2. 自动显示每个字的笔画\n3. 查看总笔画数统计',
  ...
  },
  {
    ...
    description:
      '输入父亲和母亲的血型（ABO系统），基于遗传学规律推算子女可能出现的血型以及不可能出现的血型。科普向趣味工具。',
    usage: '1. 选择父亲的血型\n2. 选择母亲的血型\n3. 查看推算结果',
  ...
  },
  {
    ...
    summary: '天气查询与生活指数建议',
    description:
      '查询全球城市天气，并生成穿衣、出行、运动等生活指南关键词。数据支持由 Open-Meteo 提供。',
    usage:
      '1. 输入城市名称（支持中文城市名，如"Beijing"或"北京"）\n2. 点击查询\n3. 查看实时天气及生活建议',
  ...
  },
  {
    ...
    summary: '长文本自动分行排版',
    description:
      '适配朋友圈、小红书、短视频文案排版。支持智能语义分行、自定义字数截断，一键生成居中诗意排版。',
    usage: '1. 粘贴长文本\n2. 调节每行字数与分行模式\n3. 预览并复制结果',
    route: '/tools/text-linebreak',
    isLocal: true,
    tags: ['排版', '文案', '换行', '歌词', '编辑']
  },
  {
    ...
    summary: '出国旅行插座与电压查询',
    description:
      '查询全球主要国家和地区的电源插座类型、电压标准及频率。提供可视化插座图鉴，帮助您准备旅行转换插头。',
    usage:
      '1. 搜索国家名称（如"日本"、"英国"）\n2. 查看该国的电压、频率及插座类型\n3. 对照图鉴确认转换头',
  ...
  },
  {
    ...
    description:
      '查询 IP 地址的地理位置（国家、城市）、运营商 (ISP)、经纬度及时区信息。支持查询本机 IP。纯前端实现，无需服务器中转。',
  ...
  },
  {
    ...
    description:
      '实时分析文本在 UTF-8 和 GBK 编码下的字节长度，并展示 16 进制字节码，帮助排查乱码问题。',
  ...
  },
  {
    ...
    summary: '常见设备分辨率与倍率',
    description:
      '收录常见手机、平板、电脑的逻辑分辨率、物理分辨率和 PPI 数据，辅助 UI 设计与适配。',
    usage: '搜索设备名称或切换分类查看。',
  ...
  },
  {
    ...
    summary: '花体/空心/下划线生成',
    description:
      '生成花体英文 (Script)、空心字 (Hollow)、删除线、下划线等特殊样式文本，用于社交平台昵称或文案。',
  ...
  },
  {
    ...
    route: '/tools/proportion-calculator',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '一款专为大学生设计的个人课程表工具。支持手动添加、文本识别导入、JSON数据迁移以及自动周次计算功能，跨端体验友好。',
  ...
  },
  {
    ...
    description:
      '集成了倒计时、正计时（秒表）、目标时间倒计时功能。支持快速预设、自定义时间、计次记录、声音提醒及浏览器通知。',
    usage: '1. 选择倒计时或正计时模式\n2. 点击预设或自定义时间开始\n3. 正计时支持计次功能',
    route: '/tools/timer',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '根据您的体重与活动水平计算建议饮水量，支持实时点击记录喝水进度，提供每日水量阶梯视图，并支持桌面提醒，助您养成健康饮水习惯。',
    usage:
      '1. 点击设置输入基础身体数据\n2. 点击"饮水"按钮快速记录\n3. 查看今日进度百分比及喝水历史',
  ...
  },
  {
    ...
    summary: '色盲测试与护眼专注工具',
    description:
      '提供标准的色敏度测试图、散光自测图以及基于 20-20-20 法则的护眼专注计时器（工作20分钟，远眺20秒，看20英尺外），科学保护您的视力。',
    usage:
      '1. 选择测试类型（色盲/散光等）\n2. 按照屏幕提示保持距离进行测试\n3. 开启护眼计时器开始专注工作',
  ...
  },
  {
    ...
    description:
      '根据末次月经日期计算预产期；按周提供胎儿发育百科知识、妈妈身体变化参考及重要产检时间提醒。',
    usage: '1. 输入末次月经日期\n2. 点击计算获取预产期及当前孕周\n3. 浏览每周发育详情和产检计划',
  ...
  },
  {
    ...
    summary: '目标导向的营养配餐建议',
    description:
      '根据您的减脂、增肌或维持体重目标，自动生成每日碳水、蛋白质、脂肪的建议摄入比例及三餐热量分配模型。',
    usage:
      '1. 输入基本身体信息和活动强度\n2. 选择您的目标（减脂/增肌等）\n3. 获取结构化的营养建议和食谱模型',
  ...
  },
  {
    ...
    description:
      '对比 Mifflin-St Jeor 与 Katch-McArdle 等国际权威公式，更精确地评估您的基础代谢率（BMR）与总消耗（TDEE），并分析体脂率对代谢的影响。',
    usage:
  ...
  },
  {
    ...
    summary: '聚合名篇与名句赏析卡片',
    description:
      '聚合唐诗、宋词、元曲经典数据库；支持按主题、作者关键词搜索，并提供古风样式的名句分享卡片生成。',
    usage: '1. 输入关键词搜索诗词\n2. 点击某首诗进入详情赏析\n3. 切换纵向排版或生成名句分享图',
    route: '/tools/poetry',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '自定义练习文字，一键生成标准田字格、米字格或方格电子字帖，支持设置临摹透明度并导出为高清图片或直接打印。',
    usage: '1. 输入想要练习的内容\n2. 面板设置格线类型与颜色\n3. 导出 PNG 或进行打印预览',
  ...
  },
  {
    ...
    summary: '交互式响应式周期表',
    description:
      '专业的交互式元素周期表，提供元素分类高亮、详细原子属性（如电子排布、原子量、发现史）等科普知识。',
  ...
  },
  {
    ...
    description:
      '创意排版工具，模拟微信朋友圈、微博等社交平台的发布内容，支持头像上传、图片网格预览。',
    usage:
      '1. 上传头像并填写用户名\n2. 输入文字内容并选择配图\n3. 调整点赞列表及时间位置\n4. 生成截图并导出分享',
    route: '/tools/social-media-mockup',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '可视化展示全球主要时区的时间差，并提供"人类活动建议"图标，直观了解世界各地的生活节奏。',
    usage:
...

  {
    ...
    description:
      '支持将 PDF 文件的每一页转换为高清图片。可选择 PNG、JPG、WebP 格式，支持自定义缩放比例和质量，方便分享和预览。',
    usage: '1. 上传 PDF 文件\n2. 选择输出格式和质量\n3. 勾选需要导出的页面\n4. 点击下载',
  ...
  },
  {
    ...
    description:
      '支持将多张图片批量合并为 PDF 文件。可选择页面尺寸（A4/A3/Letter/自适应）、页面方向，支持拖拽排序。',
    usage: '1. 上传多张图片\n2. 拖拽调整顺序\n3. 设置页面参数\n4. 生成并下载 PDF',
  ...
  },
  {
    ...
    description:
      '功能强大的 PDF 操作工具。支持按页面范围提取、逐页拆分，以及将多个 PDF 文件合并为一个文档。',
  ...
  },
  {
    ...
    description:
      '为 PDF 文件添加自定义水印。支持文字水印和图片水印，可设置透明度、旋转角度、位置（单点/平铺），保护文档版权。',
    usage: '1. 上传 PDF 文件\n2. 选择文字或图片水印\n3. 调整水印参数\n4. 下载带水印的 PDF',
  ...
  },
  {
    ...
    description:
      '专业的 IP 子网掩码计算工具。支持计算网络地址、广播地址、可用主机范围、子网掩码转换、CIDR 表示法，帮助网络规划和故障排查。',
    usage: '1. 输入 IP 地址\n2. 选择 CIDR 前缀长度\n3. 自动计算子网信息',
  ...
  },
  {
    ...
    description:
      '解析 User Agent 字符串，识别浏览器类型、版本、操作系统、设备类型、渲染引擎等信息。支持常见浏览器和移动设备识别。',
  ...
  },
  {
    ...
    description:
      '一站式查看本机网络和设备信息。包括公网 IP 及地理位置、屏幕分辨率、浏览器信息、网络连接状态、电池状态等。',
  ...
  },
  {
    ...
    description:
      '强大的 XML 处理工具。支持 XML 格式化美化、压缩混淆、语法校验，以及 XML 与 JSON 格式互相转换。',
    usage: '1. 粘贴 XML 内容\n2. 点击格式化或压缩\n3. 或使用互转功能',
  ...
  },
  {
    ...
    description:
      '配置文件格式转换工具。支持 YAML、JSON、Properties 三种格式互相转换，方便不同项目配置文件的迁移。',
    usage: '1. 选择输入格式并粘贴内容\n2. 选择输出格式\n3. 点击转换',
  ...
  },
  {
    ...
    description:
      '网站图标生成工具。上传一张图片，自动生成 favicon.ico、apple-touch-icon、android-chrome 等多种尺寸的网站图标。',
    usage: '1. 上传正方形图片\n2. 选择需要的尺寸\n3. 点击生成并下载',
  ...
  },
  {
    ...
    description:
      '便捷的快速记事工具。支持打开悬浮窗置顶显示，内容自动保存到本地，随时记录灵感和临时信息。',
    usage: '1. 在主界面直接输入内容\n2. 或点击"打开悬浮窗"获得置顶小窗口',
    route: '/tools/sticky-note',
    isLocal: true,
  ...
  },
  {
    ...
    description:
      '图片配色分析工具。上传图片即可智能提取能够代表图片风格的 8 种主要颜色，生成色卡并支持一键复制颜色代码。',
    usage: '1. 上传图片\n2. 自动提取颜色展示\n3. 点击色块复制色值',
  ...
  },
  {
    ...
    description:
      '在线 GIF 制作工具。支持将多张静态图片合成为 GIF 动图，可自定义图片顺序、帧间隔时间和画面尺寸。',
    usage: '1. 上传多张图片\n2. 调整顺序和参数\n3. 点击生成并下载',
  ...
  },
  {
    ...
    summary: '极简番茄工作法计时器',
    description:
      '助你保持专注的番茄钟工具。默认支持 25 分钟专注 + 5 分钟休息的工作流，提供清新的 UI 和自动统计功能。',
    usage: '1. 选择专注模式\n2. 点击开始\n3. 完成后休息',
  ...
  },
  {
    ...
    description:
      '在线打字练习工具。支持英文单词和代码片段两种模式，实时统计 WPM (每分钟单词数) 和准确率，助你提升键盘输入效率。',
    usage: '1. 选择模式和时间\n2. 将光标聚焦输入框\n3. 开始盲打练习',
  ...
  },
  {
    ...
    summary: '精准稳定的在线节拍器',
    description:
      '音乐练习必备的节拍器工具。提供精准的 BPM 设置、多种拍号选择和可视化节拍显示，支持重音提示。',
    usage: '1. 设定 BPM 和拍号\n2. 点击播放\n3. 跟随节拍练习',
  ...
  },
  {
    ...
    summary: 'PDF 文件压缩与优化',
    description:
      '专业的 PDF 压缩工具。支持无损结构优化（清理冗余数据）和强力图片压缩（适合扫描件）两种模式，有效减小文件体积。',
    usage: '1. 上传 PDF 文件\n2. 选择"无损优化"或"强力压缩"\n3. 点击开始并下载结果',
  ...
  },
  {
    ...
    summary: '旋转 PDF 页面方向',
    description:
      'PDF 页面方向调整工具。支持预览所有页面，一键旋转全部页面或单独调整特定页面的方向（90°/180°）。',
    usage: '1. 上传 PDF 文件\n2. 点击工具栏批量旋转或单独旋转指定页\n3. 保存并下载',
  ...
  },
  {
    ...
    description:
      'PDF 安全管理工具。支持为 PDF 设置打开密码和编辑/打印权限密码；也支持移除已知的 PDF 密码以便编辑。',
  ...
  },
  {
    ...
    description:
      'PDF 页码添加工具。支持在页面的 6 个不同位置添加页码，自定义页码格式（如 "Page 1 of N"）、字体大小和起始页码。',
    usage: '1. 上传 PDF 文件\n2. 设置页码位置和格式\n3. 预览并下载',
  ...
  },
  {
    ...
    description:
      'PDF 页面管理工具。可视化界面拖拽 PDF 页面实现重新排序，支持删除不需要的页面或在任意位置插入空白页。',
    usage:
  ...
  },
  {
    ...
    description:
      'PDF 灰度转换工具。将彩色 PDF 转为灰度模式或纯黑白，适合打印节省耗材或满足档案存储要求。',
    usage: '1. 上传 PDF 文件\n2. 选择灰度或纯黑白模式\n3. 预览效果并下载',
  ...
  },
  {
    ...
    description:
      'PDF 文本提取工具。快速提取 PDF 文档中的纯文本内容，支持复制到剪贴板或导出为 TXT 文件。',
    usage: '1. 上传 PDF 文件\n2. 点击提取文本\n3. 复制或下载文本内容',
  ...
  },
  {
    ...
    description:
      'PDF 电子签名工具。支持手写绘制签名或上传签名图片，可拖放到 PDF 的任意位置，生成带签名的文档。',
    usage: '1. 上传 PDF 文件\n2. 手写或上传签名\n3. 点击 PDF 预览放置签名位置\n4. 保存并下载',
  ...
  },
  {
    ...
    description:
      'PDF 元数据编辑工具。查看和修改 PDF 的标题、作者、主题、关键词、创建日期等属性信息。',
    usage: '1. 上传 PDF 文件\n2. 编辑需要修改的属性\n3. 保存并下载',
  ...
  },
  {
    ...
    summary: '叠加水印或印章图层',
    description:
      'PDF 叠加覆盖工具。将一个 PDF 作为水印或印章叠加到另一个 PDF 之上，支持透明度和范围设置。',
    usage: '1. 选择基础 PDF\n2. 选择叠加 PDF（水印/印章）\n3. 设置叠加模式和范围\n4. 合并并下载',
  ...
  },
  {
    ...
    summary: '调整 PDF 页面尺寸',
    description:
      'PDF 页面比例调整工具。在不改变内容的情况下，统一调整 PDF 的页面尺寸（如从 A3 调整到 A4）。',
    usage:
      '1. 上传 PDF 文件\n2. 选择目标尺寸（A4, A3等）\n3. 选择缩放模式（适应或填充）\n4. 调整并下载',
  ...
  },
  {
    ...
    summary: '提取 PDF 内嵌附件',
    description:
      'PDF 附件提取工具。检测并提取嵌套在 PDF 内部的各种文件附件（如 Excel 表格、XML 等数据文件）。',
