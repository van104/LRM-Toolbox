...
export const lifeData: LifeData = {
  ...
  talents: [
    {
      ...
      desc: '全属性+5，SSR级命格',
      rarity: 'SSR',
      effect: { looks: 5, smarts: 5, health: 5, happiness: 5 }
    },
    {
      id: 't002',
      name: '红颜薄命',
      desc: '颜值+8，健康-5',
      rarity: 'SR',
      effect: { looks: 8, health: -5 }
    },
    {
      id: 't003',
      name: '家里有矿',
      desc: '家境(快乐)+10，初始资金+5000',
      rarity: 'SR',
      effect: { happiness: 10, wealth: 5000 }
    },
    {
      id: 't004',
      name: '书呆子',
    ...
    { id: 't006', name: '运动健将', desc: '健康+8', rarity: 'R', effect: { health: 8 } },
    {
      ...
      desc: '全属性+1',
      rarity: 'N',
      effect: { looks: 1, smarts: 1, health: 1, happiness: 1 }
    },
    {
      id: 't008',
      name: '早产儿',
  ...
  housing: [
    ...
    },
    {
      ...
      desc: '交通便利，升值空间大。',
      image:
        'https://images.unsplash.com/photo-1460317442991-0ec209397118?auto=format&fit=crop&w=500&q=60'
    },
    {
      id: 'villa',
      name: '郊区别墅',
  ...
  vehicles: [
    ...
    },
    {
      ...
      desc: '省油耐用，家庭首选。',
      image:
        'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=500&q=60'
    },
    {
      id: 'luxury_car',
      name: '豪华轿车',
    ...
    },
    {
      ...
      desc: '3秒破百，回头率200%。',
      image:
        'https://images.unsplash.com/photo-1617788138017-80ad40651399?auto=format&fit=crop&w=500&q=60'
    },
    {
      id: 'yacht',
      name: '私人游艇',
      ...
      desc: '征服海洋的座驾。',
      image:
        'https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&w=500&q=60'
    }
  ],
  ...
  ageEvents: {
    ...
    1: [
      {
        text: '你学会了爬行，满屋子乱爬，把家里的花瓶打碎了。',
        effect: { smarts: 2, happiness: -2 }
      },
    ...
    2: [
      {
        text: '你开始蹒跚学步，走两步就摔个屁股墩，但你坚强地没哭。',
        effect: { health: 1, smarts: 1 }
      },
    ...
    3: [
      {
        text: '你上幼儿园小班了，因为不想离开妈妈，你在门口大哭了一场。',
        effect: { happiness: -5 }
      },
    ...
    4: [
      ...
      {
        text: '你在家里的白墙上画了一幅“抽象派大作”，被混合双打。',
        effect: { happiness: -10, smarts: 1 }
      },
    ...
    10: [
      {
        text: '十岁生日，父母为你举办了一个盛大的生日派对，邀请了很多同学。',
    ...
    17: [
      {
        text: '高二的分班考试，你和最好的朋友分到了不同班级，有些伤感。',
        effect: { happiness: -5 }
      },
    ...
    18: [
      { text: '你成年了！这是人生的重要里程碑。', effect: { happiness: 10 } },
      {
        ...
        choices: [
          {
            text: '去大城市读大学',
            effect: { smarts: 10, wealth: -5000, stress: 5 },
            log: '你来到了繁华的都市，眼界大开。'
          },
          {
            text: '留在本地读大学',
            effect: { happiness: 5, wealth: -2000 },
            log: '你选择了安逸，离家近确实很方便。'
          },
          {
            text: '直接工作',
            effect: { wealth: 2000, smarts: -5 },
            log: '你早早步入社会，体验了赚钱的不易。'
          }
        ]
      }
    ],
    19: [
      {
        text: '大学生活比你想象的要自由，你加入了感兴趣的社团。',
        effect: { happiness: 5, fame: 2 }
      },
      { text: '第一次离家这么久，中秋节的时候你格外想家。', effect: { happiness: -5 } }
    ],
    20: [
      {
        text: '大二课程开始繁重，你为了不挂科在图书馆熬夜复习。',
        effect: { smarts: 2, health: -1 }
      },
    ...
    22: [
      { text: '大学毕业了，你正式告别了学生时代。', effect: { smarts: 5 } },
      {
        ...
        choices: [
          {
            text: '考研深造',
            effect: { smarts: 10, wealth: -5000 },
            log: '你继续在学术的海洋里遨游。'
          },
          {
            text: '疯狂投简历',
            effect: { wealth: 3000, health: -2 },
            log: '你成为了一名社畜，开始了996的生活。'
          },
          {
            text: '间隔年环游中国',
            effect: { happiness: 20, wealth: -10000 },
            log: '你花光了积蓄，但收获了无数在路上的故事。'
          }
        ]
      }
    ],
    ...
    27: [{ text: '你在工作中开始独当一面，领导对你很赏识。', effect: { fame: 2, wealth: 1000 } }],
    28: [
      { text: '你感觉身体不如以前了，熬夜后很难恢复。', effect: { health: -2 } },
      { text: '你参加了高中同学聚会，大家变化都很大。', effect: { happiness: 2 } }
    ],
    29: [{ text: '二十九岁，站在三十岁的门槛上，你有些焦虑。', effect: { stress: 5 } }],
    30: [
    ...
    45: [
      {
        text: '父母年纪大了，身体开始出现各种毛病，你经常要跑医院。',
        effect: { happiness: -5, wealth: -2000 }
      },
  ...
  periods: {
    child: [
      {
        text: '你在公园玩泥巴，弄得一身脏兮兮的，但很开心。',
        effect: { happiness: 3, health: -1, looks: -1 },
        minAge: 2
      },
      { text: '换季了，你不小心感冒了，鼻涕流个不停。', effect: { health: -5 }, minAge: 0 },
      {
        text: '因为挑食不吃青椒，你在饭桌上被父母教育了一顿。',
        effect: { health: -1, happiness: -2 },
        minAge: 3
      },
      { text: '你在路边蹲了半小时，观察蚂蚁搬家。', effect: { smarts: 2 }, minAge: 4 },
      {
        text: '因为不想午睡，你大哭大闹，吵醒了全家人。',
        effect: { happiness: -2 },
        minAge: 1,
        maxAge: 5
      },
      {
        text: '你在期末考试中考了满分，父母奖励了你想要的玩具。',
        effect: { smarts: 2, happiness: 5, wealth: 100 },
        minAge: 6
      },
      {
        text: '你在学校才艺表演上唱了一首歌，虽然跑调了但勇气可嘉。',
        effect: { fame: 2, happiness: 2 },
        minAge: 6
      },
      {
        text: '你偷偷把家里的闹钟拆了，结果装不回去了。',
        effect: { smarts: 3, wealth: -50 },
        minAge: 5
      },
      {
        text: '被隔壁家的小胖欺负了，你哭着跑回了家。',
        effect: { happiness: -5, fame: -1 },
        minAge: 4
      },
      {
        text: '你在小区里捡到了一只流浪小狗，央求父母收养它。',
        effect: { happiness: 10, wealth: -200 },
        minAge: 5
      },
      {
        text: '你被选入学校合唱团，开始每天练习唱歌。',
        effect: { fame: 2, happiness: 3 },
        minAge: 7
      },
      {
        ...
        choices: [
          {
            ...
            log: '你勇敢地说了不，虽然挨了一拳，但他们被你的气势吓跑了。'
          },
          {
            text: '乖乖给钱',
            effect: { wealth: -50, happiness: -5 },
            log: '你破财免灾，但心里觉得很窝囊。'
          },
          {
            text: '告诉家长',
            effect: { smarts: 2, fame: -2 },
            log: '家长到学校解决了问题，但你被嘲笑是由于没断奶。'
          }
        ],
        minAge: 7
      }
    ...
    teen: [
      ...
      {
        text: '你在校运会长跑比赛中获得了第一名，全班为你欢呼。',
        effect: { health: 5, fame: 10 },
        minAge: 13
      },
      { text: '因为发型问题，你被教导主任在校门口拦住了。', effect: { happiness: -5 }, minAge: 13 },
      { text: '你收到了一封情书，心里小鹿乱撞。', effect: { happiness: 10, fame: 2 }, minAge: 14 },
      {
        text: '你第一次尝试喝酒，结果一杯就倒了。',
        effect: { health: -2, happiness: 2 },
        minAge: 16
      },
      {
        text: '你被选为交换生，有机会去国外游学一周。',
        effect: { smarts: 5, wealth: -5000 },
        minAge: 15
      },
      {
        ...
        choices: [
          {
            ...
            log: '你玩得很开心，周一补作业补到手断。'
          },
          {
            text: '在家写作业',
            effect: { smarts: 5, happiness: -5 },
            log: '你是个乖孩子，但错过了一次聚会。'
          }
        ],
        minAge: 13
      ...
      {
        text: '你迷上了一本小说，上课都在偷偷看。',
        effect: { smarts: -2, happiness: 5 },
        minAge: 13
      }
    ],
    adult: [
      ...
      {
        text: '为了减肥，你办了张健身卡，虽然去的次数屈指可数。',
        effect: { wealth: -2000, health: 1 }
      },
      ...
      {
        text: '你做了一顿丰盛的晚餐，邀请朋友来家里聚餐。',
        effect: { happiness: 5, wealth: -500 }
      },
      ...
      {
        text: '你拿出积蓄付了首付，终于在这个城市有了自己的小窝。',
        effect: { wealth: -500000, happiness: 30 }
      },
      {
        ...
        choices: [
          {
            text: '接受挑战',
            effect: { wealth: 50000, happiness: -5 },
            log: '薪水翻倍，但你开始想念家乡的红烧肉。'
          },
          {
            text: '婉言拒绝',
            effect: { happiness: 5, fame: -5 },
            log: '你选择了陪伴家人，放弃了高薪。'
          }
        ]
      },
    ...
    elder: [
      ...
      { text: '你报名参加了老年大学的摄影班。', effect: { smarts: 3, happiness: 5 } },
      {
        ...
        choices: [
          {
            text: '报名参加',
            effect: { health: 2, wealth: -3000, happiness: 10 },
            log: '虽然腿脚有点累，但风景真好。'
          },
