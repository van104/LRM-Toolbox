...
export const popularCurrencies = ['CNY', 'USD', 'EUR', 'JPY', 'HKD', 'GBP', 'AUD', 'CAD', 'CHF', 'KRW']
...
export async function getLatestRate(from, to, amount = 1) {
    try {
...
export function formatHistoryForChart(historyData, targetCurrency) {
